...
public class QuestionContainer : MonoBehaviour
{
    ...
    private QuestionItem1 questionItem;
    private QuestionScrollList scrollList;
    ...
    public void Setup(QuestionItem1 currentItem, QuestionScrollList currentScrollList)
    {
